...
if __name__ == '__main__':
    ...
    animal1 = AnimalFabric(animal_class='bird', name='ворона', age=3, color='серая', voice='кар').get_info_animal()
    print(animal1.get_info())

    animal2 = AnimalFabric(animal_class='mammal', name='собака', age=10, hair='короткая шерсть', voice='гав', color='серый').get_info_animal()
